...
public class SignUpActivity extends AppCompatActivity {
    private TextInputEditText edit_name, edit_email, edit_password, edit_confPass, edit_phone;
...
//         tv_loginnow
    ...
    private void createInfo(String userUid) {
        Common.FIREBASE_DATABASE.getReference(Common.REF_USERS).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
        ...
        alert.setMessage("Vui lòng xác thực tài khoản, đã gửi về email của bạn");
